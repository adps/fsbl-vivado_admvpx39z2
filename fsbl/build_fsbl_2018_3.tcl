...
set workspace_dir $current_dir/9z2_workspace
set fsbl_sources_dir $current_dir/sources/

set hw_proj 9z2_hw
set bsp_proj 9z2_bsp
set pmufw_bsp_proj 9z2_pmufw_bsp
set fsbl_proj 9z2_fsbl
set pmufw_proj 9z2_pmufw
...
sdk createhw -name $hw_proj -hwspec $fsbl_sources_dir/hdf/admvpx39z2_simple_sdcard_DP_usb_2018.3.hdf
