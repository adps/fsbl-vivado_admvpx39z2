...
#
# Generated by Vivado on Mon Feb 11 10:26:36 +0000 2019
...
#    "F:/svn_repo/ch_repo/ZynqMPSoC/fpga/vhdl/simple_9z2_wrapper.vhd"
...
proc create_hier_cell_ClockGeneration { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__TOPSW_MAIN_CTRL__ACT_FREQMHZ {441.666656} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {95.454544} \
...
#  -string -flagsOSRD
preplace port dp_aux_data_out -pg 1 -y 80 -defaultsOSRD
preplace port dp_hot_plug_detect -pg 1 -y 60 -defaultsOSRD
preplace port REFCLK_100M1 -pg 1 -y 20 -defaultsOSRD
preplace port dp_aux_data_in -pg 1 -y 40 -defaultsOSRD
preplace portBus P2_AUX_EN_L -pg 1 -y 20 -defaultsOSRD
preplace portBus P2_GP_EN_L -pg 1 -y 40 -defaultsOSRD
preplace portBus dp_aux_data_oe -pg 1 -y 60 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -y 770 -defaultsOSRD
preplace inst ClockGeneration -pg 1 -lvl 1 -y 40 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 1 -y 610 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 1 -y 370 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 1 -y 490 -defaultsOSRD
preplace inst NibbleSwap -pg 1 -lvl 1 -y 190 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_dp_aux_data_oe_n 1 0 2 20 670 620
preplace netloc rst_util_ds_buf_1_100M_peripheral_aresetn 1 0 2 0 260 630
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 2 -20 100 640
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 0 2 10 550 630
preplace netloc axi_smc_M00_AXI 1 0 2 0 110 620
preplace netloc util_vector_logic_0_Res 1 1 1 660
preplace netloc dp_aux_data_in_1 1 0 1 -30
preplace netloc xlconstant_0_dout 1 1 1 650
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 -10 270 640
preplace netloc dp_hot_plug_detect_1 1 0 1 -40
preplace netloc zynq_ultra_ps_e_0_dp_aux_data_out 1 1 1 670
preplace netloc REFCLK_100M1_1 1 0 1 -30
levelinfo -pg 1 -60 320 690 -top -30 -bot 870
"
}
...
cr_bd_simple_9z2 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files simple_9z2.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files simple_9z2.bd ] 

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu15eg-ffvb1156-2-i -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu15eg-ffvb1156-2-i -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
