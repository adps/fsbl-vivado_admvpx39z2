...
--Command     : generate_target boardtest_9z2_wrapper.bd
--Design      : boardtest_9z2_wrapper
...
entity boardtest_9z2_wrapper is
  port (
...
end boardtest_9z2_wrapper;

architecture STRUCTURE of boardtest_9z2_wrapper is
  component boardtest_9z2 is
  port (
    REFCLK_100M1_clk_p : in STD_LOGIC_VECTOR ( 0 to 0 );
    REFCLK_100M1_clk_n : in STD_LOGIC_VECTOR ( 0 to 0 );
    dp_aux_data_in : in STD_LOGIC;
  ...
  end component boardtest_9z2;
begin
boardtest_9z2_i: component boardtest_9z2
     port map (
